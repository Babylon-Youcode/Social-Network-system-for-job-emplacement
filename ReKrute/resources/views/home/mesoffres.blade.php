    ...
    <main>
        <table class="table">
            ...
            <tr>
                ...
                <td><a href="../delete/{{$emploi->id}}">Delete</a> |             <button type="submit" data-toggle="modal" class="btn mt-1  btn-primary  "  data-target="#update-modal"  >Update emploi <i class="fas fa-user"></i></button>     
                </td>
            </tr>
